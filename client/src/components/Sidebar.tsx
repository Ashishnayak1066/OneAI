    ...
    <div className="w-64 min-w-64 h-full bg-gray-50 border-r border-gray-200 flex flex-col">
      ...
      <div className="p-3">
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2.5 rounded-lg bg-black hover:bg-gray-800 transition-all text-white"
        >
      ...
      <div className="flex-1 overflow-y-auto px-3 pb-3">
        <div className="space-y-1">
          {chats.map((chat) => (
            <div
              key={chat.id}
              className={`group flex items-center gap-1.5 px-2.5 py-2 rounded-md cursor-pointer transition-all ${
